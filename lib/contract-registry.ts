...
const KNOWN_CONTRACTS: ContractInfo[] = [
  ...
  },
  {
    ...
    address: "",
    network: "arc",
    description: "Identity Registry ERC-8004 para agentes CriptoMorse. ERC-721 com trust levels, payment addresses, integração ERC-8183. Ainda não deployado.",
    source: "contracts/AgentIdentity.sol",
    deployTx: "",
    explorerUrl: "",
    abi: AGENT_IDENTITY_ABI,
    tags: ["identity", "erc8004", "nft", "arc", "nao-deployado"],
  },
